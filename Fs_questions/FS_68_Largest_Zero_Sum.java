...
public class FS_68_Largest_Zero_Sum {
...
Legend says that stepping on a sequence of tiles whose sum is exactly zero will 
unlock the hidden vault door. 
However, the hunter’s time is short: they must find the longest such contiguous 
stretch of tiles to trigger the mechanism before the temple collapses.
...
Explanation: The longest sub-array with elements summing upto 0 is 
[-1, 1, -6, 1 5]
